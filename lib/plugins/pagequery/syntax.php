...
class syntax_plugin_pagequery extends DokuWiki_Syntax_Plugin {
    ...
    private function _build_sorting_array($ids, $get_abstract, $opt) {
        ...
        foreach ($ids as $id) {
			...
			//Added By Sam To Try To Get A Better Abstract
			$meta['description']['abstract'] =  p_get_instructions('{{page>libraries:lifa:getting_started#Overview&noheader}}'); //no caching on old revisions
